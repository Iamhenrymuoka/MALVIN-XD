...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~E1pnwZRL#cDAnsbwxh325w4SsY26-UY3plIfuN3b7G5YgVQ__nfk",
// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "✦Henry v2",
// add bot name here for menu

CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
// make this true for custum emoji react   

STICKER_NAME: process.env.STICKER_NAME || "HENRY-XD",
...
OWNER_NAME: process.env.OWNER_NAME || "✦Henry Tech🪀✦",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ✦Henry ᴛᴇᴄʜ✦ ɪɴᴄ*",
// add bot owner name    
...
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*🎉👀 Status Seen by Henry xᴅ v2🚀🔥*",
